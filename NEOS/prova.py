...
# print(data['EH1'][:,0])
print(Neos_test.calculate_naked_event_expectation_simple(Model_osc,'NEOS',0))
# print(Neos_test.calculate_naked_event_expectation_noLint(Model_osc,'NEOS',4))
# print(Neos_test.get_poisson_chi2(Model_osc_bad))
end_time = time.time()
