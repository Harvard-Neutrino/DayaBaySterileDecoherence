...
for i in range(3):
    axev[i].scatter(x_ax,pred[0][DB_test.sets_names[i]][:,0]/deltaE/1.e5,marker="o",color = "blue", label = "Our prediction")
    axev[i].scatter(x_ax,DB_test.AllData[DB_test.sets_names[i]][:,4]/deltaE/1.e5,marker="o",color = "red", label = "DB prediction")
...
figev.savefig("Event expectation_nonorm.png")
