...
def CrossSection(Enu):
    """
    Input:
    Enu (double): Real energy of the incoming neutrino, in MeV.

    Output:
    Cross-section of the IBD process, in cm^2.
    """
